...
const Temperature = () => {
    ...
    temperatureSensors: [
      {
        id: "temp_general",
        name: "Temperature",
        description: "Overall system temperature monitoring",
        currentValue: 45,
        maxValue: 72,
        warningLevel: 75,
        unit: "°C",
      ...
      {
        id: "cascade_temp",
        name: "Cascade Temperature", 
        description: "Multi-stage compression system monitoring",
        currentValue: 52,
        maxValue: 68,
        warningLevel: 75,
        unit: "°C",
      ...
      {
        id: "storage_temp",
        name: "Temporary Storage Tank Temperature",
        description: "Storage vessel thermal management", 
        currentValue: 28,
        maxValue: 45,
        warningLevel: 75,
        unit: "°C",
      ...
      {
        id: "booster_output_temp",
        name: "Booster Output Temperature",
        description: "Pressure boost system thermal control",
        currentValue: 61,
        maxValue: 78,
        warningLevel: 75,
        unit: "°C", 
      ...
      },
      {
        ...
        description: "Boost pump thermal management",
        currentValue: 42,
        maxValue: 59,
        warningLevel: 75,
        unit: "°C",
  ...
  const getTemperatureStatus = (temperature) => {
    ...
    if (temperature >= ranges.danger.min) {
      return { status: 'danger', color: ranges.danger.color, label: ranges.danger.label };
    } else if (temperature >= ranges.caution.min) {
      return { status: 'caution', color: ranges.caution.color, label: ranges.caution.label };
    } else {
      return { status: 'safe', color: ranges.safe.color, label: ranges.safe.label };
    }
  };
  ...
  const simulateTemperatureChanges = () => {
    setSensorData(prevData => {
      const updatedSensors = prevData.temperatureSensors.map(sensor => {
        ...
        const newMaxValue = newTemp > sensor.maxValue ? newTemp : sensor.maxValue;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[rgba(31,_33,_33,_1)]">
      {/* Header */}
      <header className="bg-[rgba(31,_33,_33,_1)] shadow-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3">
          <div className="system-info">
            <h1 className="text-3xl font-bold mb-2 text-white">
              Tank Temperature and Mass Monitoring
            </h1>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-400">
                    <div className="metric">
                      ...
                      <div>{sensor.maxValue}{sensor.unit}</div>
                    </div>
                    <div className="metric">
                      <div className="font-medium">Warning Level</div>
                      <div>{sensor.warningLevel}{sensor.unit}</div>
                    </div>
                    <div className="metric">
